...
# 
#
# It can be executed with the bash iptables.sh
# installation instructions
#Let the iptables.sh execute when system boot
# vim /etc/inittab
#add "IPT:235:respawn:/PATH/TO/iptables.sh
...
# Internet Interface
#reconfig it based on your environment
INET_IFACE="eth0"
INET_ADDRESS="192.168.0.1"
